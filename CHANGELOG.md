...
- Разобрался с формированием пакета:
    + Теперь файлы данных пишутся в папку /usr/games/${PROJECT_NAME}/ для Linux
    или $ENV{PROGRAMFILES}/${PROJECT_NAME} для Windows
- Генерируемые файлы: журнал, настроеки теперь создаются в каталоге $ENV{HOME}/.${PROJECT_NAME}
- Добавил отображение обитателей в виде смайликов
